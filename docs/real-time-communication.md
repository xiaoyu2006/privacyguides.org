...
5. Change the **Who can see my phone number** setting to: **Nobody**

You can optionally change the **Who can find me by my phone number** to **Nobody** as well if you want to prevent people who already have your phone number from discovering your Signal account/username.
